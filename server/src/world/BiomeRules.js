export const BIOME_RULES = {
    ...
    forest: {
        ...
        resources: [
            { type: "tree", density: 0.07 },           // 10% - primary resource
            { type: "berry", density: 0.04 },          // 5% - food source
            { type: "log", density: 0.01 },            // 4% - building material
    ...
    desert: {
        ...
        resources: [
            { type: "rock", density: 0.01 },           // 10% - very abundant
            { type: "sand", density: 0.01 },           // 7% - abundant
    ...
    snow: {
        ...
        resources: [
            { type: "rock", density: 0.02 },           // 6% - abundant stone
    ...
    swamp: {
        ...
        resources: [
            ...
            { type: "ore", density: 0.01 }             // 2% - bog ore
        ]
    }
};